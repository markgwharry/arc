...
function App() {
  ...
  return (
    <div className="min-h-screen">
      {/* Header */}
      <header className="bg-arc-dark border-b border-gray-800 sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-sm text-gray-500">Community-powered item database</p>
            </div>
            {stats && (
              <div className="text-right text-sm text-gray-500">
                <span className="text-arc-accent font-semibold">{stats.total_items}</span> items
              </div>
            )}
          </div>
        ...
        {error && (
          <div className="bg-red-900/20 border border-red-800 rounded-lg p-4 mb-4">
            ...
            <p className="text-sm text-gray-400 mt-1">
              Showing cached data if available. Check your connection.
            </p>
          </div>
        )}
      ...
      {/* Footer */}
      <footer className="bg-arc-dark border-t border-gray-800 mt-12">
